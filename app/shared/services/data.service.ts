...
export class DataService {
	...
	constructor() {
		...
		var useStatic = true; // If you don't want to use a backend API you can turn this on to load from static json files, saving and updates will error on their post/put requests!
